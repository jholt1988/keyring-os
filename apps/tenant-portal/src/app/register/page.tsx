...
import { UserPlus, Lock, ArrowRight, AlertCircle, Home } from 'lucide-react';
...
export default function TenantRegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Backend forces TENANT role on public self-registration regardless of what we send.
      ...
      <Card className="relative w-full max-w-md border-white/10 bg-[#13233C]/95 shadow-[0_18px_60px_rgba(2,8,23,0.28)] backdrop-blur-xl">
        <CardHeader className="space-y-1 border-b border-white/8 pb-6 text-center">
          ...
          <CardDescription className="text-[#94A3B8]">
            Register to access your tenant portal
          </CardDescription>
        </CardHeader>
        <CardContent className="pt-6">
          ...
          <div className="mt-4 text-center text-sm text-[#94A3B8]">
            ...
            <Link href="/login" className="text-[#38BDF8] hover:underline">Sign in</Link>
          </div>
        </CardContent>
      </Card>
    </div>
