...
import { createVendor, fetchVendors, getVendors1099ExportUrl } from '@/lib/operator/vendors';
...
export default function VendorsPage() {
  ...
  return (
    <>
      <WorkspaceShell title="Vendors" subtitle="Vendor management and 1099 export" icon={Building} actions={<><Button size="sm" variant="outline" onClick={async () => { const url = await getVendors1099ExportUrl(); window.open(String(url), '_blank', 'noopener,noreferrer'); }}><Download size={12} /> Export 1099</Button><Button size="sm" onClick={() => setOpen(true)}><Plus size={12} /> Add Vendor</Button></>}>
